export const PROGRAM_REVISION = "3.0";
// Legacy clearance enums below are for archived data only. Active policy uses SafetyProfile.
/**
 * Единая точка правды по версии программы.
 * Раньше строка "h2-v9-1.0" была продублирована в семи файлах и в ключе localStorage.
 */
export const ACTIVE_PROGRAM_VERSION = "h2-v9-4.0" as const;
export const PREVIOUS_PROGRAM_VERSION = "h2-v9-3.0" as const;
...
export const CLEARANCE_LEVEL_CEILING_PERCENT: Readonly<
  Record<ClearanceLevel, number>
> = {
  level_1: 85,
  level_2: 92.5,
  level_3: 100,
...
export function isClearanceLevel(value: unknown): value is ClearanceLevel {
  return (
    typeof value === "string" &&
    (CLEARANCE_LEVELS as readonly string[]).includes(value)
  );
}
