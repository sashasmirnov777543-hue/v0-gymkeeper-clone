 ...
 */
export const ACTIVE_PROGRAM_VERSION = "h2-v9-2.0" as const;
export const PREVIOUS_PROGRAM_VERSION = "h2-v9-1.0" as const;
export type ActiveProgramVersion = typeof ACTIVE_PROGRAM_VERSION;

/** Уровни медицинского допуска редакции 2.0. Определяют потолок интенсивности. */
